<template>
    <div @click="checkClick" ref="invoiceWrap" class="invoice-wrap flex flex-column">
        <form @submit.prevent="submitFrom" class="invoice-content">
            <h1>New Invoice</h1>
            <div class="bill-from flex flex-column">
                ...
                <div class="bill-to flex flex-column">
                    <h4>Bill To</h4>
                    <div class="input flex flex-column">
                        <label for="clientName"> Client is Name</label>
                        <input required type="text" id="clientName" v-model="clientName">
                    </div>
                    <div class="input flex flex-column">
                        <label for="clientEmail"> Client is Email</label>
            ...
            <div class="invoice-work flex flex-column">
                ...
                <div class="input flex flex-column">
                        <label for="productDescription">Product Descrition</label>
                ...
                <div class="work-items">
                    <table class="item-list">
                        ...
                        <tr class="table-items flex" v-for="(item, index) in invoiceItemList" :key="index">
                            ...
                            <th class="total">${{item.total = item.qty * item.price}}</th>
                            <img @click="delteInvoiceItem(item.id)" src="../assets/icon-delete.svg" alt="">
                        </tr>
                    </table>
            ...
            <div class="save flex">
                ...
                <div class="right flex">
                    <button @click.prevent = "saveDraft" class="dark-purple">Save Draft</button>
                    <button @click.prevent = "publishInvoice" class="purple">Create Invoice</button>
                </div>
            </div>
        </form>
    </div>    
